...
class OutcomeModelRepository:
    ...
    def __init__(self):
        self._models = {}
        self._models[OutcomeType.CARDIOVASCULAR] = {
        ...
        self._models[OutcomeType.MORTALITY] = self.initialize_cox_model("nhanesMortalityModel")
    ...
    def select_model_for_person(self, person, outcome):
        ...
        if outcome == OutcomeType.MORTALITY:
            return models_for_outcome
        elif outcome == OutcomeType.CARDIOVASCULAR:
