...
class GCPModel:
    ...
    def calc_linear_predictor(self, person):
        return self.calc_linear_predictor_for_patient_characteristics(years_in_simulation=person.years_in_simulation(),
    ...
    def get_risk_for_person(self, person, years=1, vectorized=False):
        return self.calc_linear_predictor_vectorized(person) if vectorized else self.calc_linear_predictor(person)
